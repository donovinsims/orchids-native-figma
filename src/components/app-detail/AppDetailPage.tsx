...
interface RelatedApp {
  ...
  export default function AppDetailPage({ 
    ...
    const content = (
      <motion.div
        className={`relative w-full ${isInline ? 'max-w-4xl mx-auto' : isMobile ? 'max-w-4xl bg-background-primary rounded-t-[32px]' : 'max-w-3xl bg-background-primary rounded-2xl border border-border'} shadow-2xl overflow-hidden flex flex-col ${isInline ? 'shadow-none border-none' : ''}`}
